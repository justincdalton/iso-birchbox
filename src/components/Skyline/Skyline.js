    ...
    return (
      ...
      <div className="container vertical-center-parent" style={{opacity: 1, display: 'block'}}>
        <div className="vertical-center skyline-content row">
          <div className="span5">
            <h2 className="copy-header-page-light copy-uppercase">MORNING RITUALS</h2>
      <p>Savor summer''s quiet moments, from cooling shaves to a cup of cold brew.</p>
              <button className="btn btn-trans">Shop Now</button>
          </div>
        </div>
      </div>
      </a>
      ...
      <div className="container vertical-center-parent" style={{opacity: 1, display: 'block'}}>
        <div className="vertical-center skyline-content row">
          <div className="span5">
            <h2 className="copy-header-page-light copy-uppercase">American Heritage</h2>
      <p>Feeling patriotic? Our newest featured box, packed with homegrown splendor, can now be purchased in the Shop.</p>
              <button className="btn btn-trans">Shop Now</button>
          </div>
        </div>
      </div>
